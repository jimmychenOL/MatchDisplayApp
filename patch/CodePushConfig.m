...
- (instancetype)init
{
    ...
    NSString *availableServerUrl = [userDefaults stringForKey:@"AvailableServerUrl"];
    if (availableServerUrl) {
        serverURL = availableServerUrl;
    }

    NSLog(@"[OLNativeUtils] availableServerUrl: %@", availableServerUrl);
//    if (!serverURL) {
